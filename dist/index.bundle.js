...
*/
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ default: () => __WEBPACK_DEFAULT_EXPORT__,
          /* harmony export */ ProjectRenderer: () =>
            /* binding */ ProjectRenderer,
          /* harmony export */
        });
        /* harmony import */ var _events_js__WEBPACK_IMPORTED_MODULE_0__ =
          ...
          function add(name) {
            ...
            function addTodo(
              ...
              function edit(field, change) {
                ...
                _saveToLocalStorage();
                _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].emit(
                  "projectsUpdate"
                );
...
elements immediately. */
        ...
        const ProjectRenderer = (function () {
          ...
          function _appendTodoAdder(sortBar, projectName) {
            ...
            const addNewTodo = (e, addForm) => {
              ...
              const description =
                addForm.querySelector(".todo-description").textContent;
          ...
          function _appendTodoRemover(sortBar) {
            ...
            const removeElement = (e) => {
              ...
              const todoTitle =
                parentElement.querySelector(".todo-title").textContent;
            ...
            const startRemoveEditor = (e) => {
              ...
              removeBtn.addEventListener("click", exitRemoveEditor, {
                once: true,
              });
            };
            ...
            const exitRemoveEditor = (e) => {
              ...
              removeBtn.addEventListener("click", startRemoveEditor, {
                once: true,
              });
            };
          ...
          function _submitTodoChanges(Todo) {
            ...
            if (
              ...
              if (Todo.title.element.textContent !== Todo.title.text) {
                Projects.find(parentProject)
                  .findTodo(title)
                  .edit("title", newTitle);
                // checks if old todo title exists, and resets textContent if still does
                if (
                  typeof Projects.find(parentProject).findTodo(title) ===
                  "object"
                ) {
                  Todo.title.element.textContent = Todo.title.text;
                  titleChanged = false;
          ...
          function _appendTodoEditor(todoElement) {
            ...
            editBtn.addEventListener("click", (e) => {
              ...
              Todo.submitBtn.addEventListener("click", submitHandler, {
                once: true,
              });
            });
          }
          ...
          function off() {
            _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].off(
              "projectsUpdate",
              _renderProjects
            );
      ...
      at the cost of creating a closure. */
              _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].on(
                "projectsUpdate",
                _renderProjects
              );
  ...
  \**********************/
    ...
    /* harmony import */ var _modules_projects_js__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./modules/projects.js */ "./src/modules/projects.js"
      );
    ...
    if (
      ...
      _modules_projects_js__WEBPACK_IMPORTED_MODULE_1__["default"]
        .add("New Project")
        .find("New Project")
        .addTodo(
      ...
      _modules_projects_js__WEBPACK_IMPORTED_MODULE_1__[
        "default"
      ].getFromLocalStorage();
    }
